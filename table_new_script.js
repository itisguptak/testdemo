	...
	var new_ip=document.getElementById("new_ip0").value;
	 ...
	 var row = table.insertRow(table_len).outerHTML="<tr id='row"+table_len+"'>" +
	 		"<td id='ip_col"+table_len+"'>" +
	 				...
	 				"<input type='text' disabled='disabled' id='new_ip"+table_len+"' value='"+new_ip+"' ></td>" +
	 		"<td id='port_col"+table_len+"'>" +
	 				"<label id='Port'>Port : </label> " +
	 				"<input type='text' id='new_port"+table_len+"' disabled='disabled' value='"+new_port+"' ></td>" +
	 		"<td id='label_col"+table_len+"'>" +
	 				"<label id='Label'>Label : </label> " +
	 				"<input type='text' id='new_label"+table_len+"' disabled='disabled' value='"+new_label+"' ></td>" +
